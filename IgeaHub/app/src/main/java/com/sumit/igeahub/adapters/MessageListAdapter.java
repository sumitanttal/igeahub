...
public class MessageListAdapter extends RecyclerView.Adapter<MessageListAdapter.ViewHolder> {
        ...
        Context mContext;
        Activity    mActivity;
    List<Message_Users_List_Pojo> comments;
        RecyclerView recyclerview;
        RecyclerView mRecyclerViewAllUserListing;

        public MessageListAdapter(Context applicationContext, List<Message_Users_List_Pojo> articles) {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
             ...
             Glide.with(mContext)
                    .load(comments.get(position).getUserimage()).placeholder(mContext.getResources().getDrawable(R.drawable.ic_default_user))
                    .into(holder.image);
        }
